...
### 2a. Paper Notes: DRL-HF
**1-liner:** Learn a reward model using human preference labels comparing pairs of trajectory segments, then train the policy with RL instead of using per-step environment rewards.

**Math:** Train $r$ using binary cross-entropy loss.
$$
